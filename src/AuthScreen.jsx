...
export default function AuthScreen() {
  ...
  const zalogujDiscord = async () => {
    ...
    if (Capacitor.isNativePlatform()) {
      ...
      // otwieramy dzialajaca strone webowa, ale ostylowana pod appke
      // (kolor paska = kolor marki), zeby nie wygladalo jak obca przegladarka.
      await Browser.open({
        url: 'https://szpontrank.eu/rejestracja',
        toolbarColor: '#FF4D4D',
